...
def run():
    ...
    drop_get = ttk.OptionMenu(root, choosing_get, options[1], *options, style='my.TMenubutton')
    ...
    class Energy():
        ...
        def calculate(self):
            ...
            # Joules
            function_same('Joules')
            function_multiply('Kilojoules' , 'Joules' , 1_000)
            function_multiply('Food Calories', 'Joules', 4_184)

            # Kilojoules
            function_divide('Joules' , 'Kilojoules' , 1_000)
            function_same('Kilojoules')
            function_multiply('Food Calories', 'Kilojoules', 4.184)

            # Food Calories
            function_divide('Joules', 'Food Calories', 4_184.10041841)
            function_divide('Kilojoules', 'Food Calories', 4.1839953809)
            function_same('Food Calories')


    Energy_calculations = Energy()
    ...
    for j in range(4, 7):
        for k in range(3):
            ...
            button[i]['command'] = lambda x=numbers[i]: Energy_calculations.entering_numbers(x)
            i += 1
    ...
    Zero_button = Button(root, text='0', width=9, height=1, font=('arial', 20, 'bold'), bd=4,
                         bg='white', activebackground='gray78' , command = lambda : Energy_calculations.entering_numbers(0))
    ...
    Dot_button = Button(root, text='.', width=9, height=1, font=('arial', 20, 'bold'), bd=4,
                         bg='gray91', activebackground='gray78' , command = lambda : Energy_calculations.entering_numbers('.'))
    ...
    Result_button = Button(root , text = 'Calculate' , font=('arial', 20, 'bold') ,  width=9, height=1 , bd=4 ,
                           bg="SteelBlue1" , activebackground = 'SteelBlue3' , command = Energy_calculations.calculate)
    ...
    Clear_last_button = Button(root, text='⌫', width=9, height=1, font=('arial', 20, 'bold'), bd=4,
                               bg="gray91", activebackground='gray78' , command = Energy_calculations.remove_last)
    ...
    AllClear_button = Button(root, text=chr(67), width=9, height=1, font=('arial', 20, 'bold'), bd=4,
                             bg="gray91", activebackground='gray78' , command = Energy_calculations.clear_entry)
